...
//转台 带参数指令 表单提交//////////////////////////////////
    $('#gimbalSbmt').click(function () {
        ...
        var formData = new FormData(form[0]); //转为js-dom对象
		//执行ajax
			$.ajax ({
              type: 'post',
              url : '/xinglong/at80/at80GimbalSendData',
...
//转台 表单提交按钮 hover //////////////////////////////////
   ...
   $('#ccdConnect').click(function (){
       ...
       $.ajax({
            type : 'post',
            url : '/xinglong/at80/at80CcdSendData',
            data : {ccdConnect:1},             
            success:  function (info) {
               alert(info);
			   if (info.indexOf('登录') !== -1)
...
//调焦器 连接按钮 js事件///////////////////////////////////
   $('#focusConnect').click(function (){
       ...
       $.ajax({
            type : 'post',
            url : '/xinglong/at80/at80FocusSendData',
            data : {focusConnect:1},             
            success:  function (info) {
               alert(info);
				if (info.indexOf('登录') !== -1)
...
//随动圆顶 连接按钮 js事件///////////////////////////////////
   $('#sDomeConnect').click(function (){
       ...
       $.ajax({
            type : 'post',
            url : '/xinglong/at80/at80sDomeSendData',
            data : {sDomeConnect:1},             
            success:  function (info) {
               alert(info);
			   if (info.indexOf('登录') !== -1)
...
            },
   ...
   $('#filterConnect').click(function (){
       ...
       $.ajax({
            type : 'post',
            url : '/xinglong/at80/at80FilterSendData',
