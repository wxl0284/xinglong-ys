...
class Control extends Controller
{
    ...
    public function weatherMore1 ()
    {
		...
		$tmpData = json_encode([12,15,18,21,25,27,29,32]); //温度-露点温度-湿度图  温度
		$dewPointData = json_encode([-2.2,-1.8,0.2,-1.6,-2.0,-2.5,0.3,-1.7]); //温度-露点温度-湿度图  温度
		$humiData = json_encode([18,18.7,19.2,18.2,17.7,20,21,18.7]); //温度-露点温度-湿度图  温度
