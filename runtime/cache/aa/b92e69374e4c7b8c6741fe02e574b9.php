...
//000000003600
 exit();?>
s:68382:"<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html>
 <head> 
 ...
 <body> 
   ...
   <div class="logo_menu"> 
      ...
      <div id="search_box"> 
       <form id="search_form" action="#"> 
        ...
        <div id="search_button"> 
         <input type="image" src="http://image.nmc.cn/static2/site/nmc/themes/basic/images/search_button.png" style="width: 24px; height: auto;" alt="搜索" title="搜索"> 
        </div> 
       </form> 
      </div> 
     </div> 
    ...
    <div id="navbar" class="menu"> 
     <ul> 
      ...
      <li id="nav-469" class="actived"><a href="/publish/forecast/china.html" target="_self">城市预报</a></li> 
      <li id="nav-336"><a href="/publish/weather-bulletin/index.htm" target="_self">天气预报</a></li> 
  ...
  <div id="navbar_sub" class="navbar_sub shadow"> 
   ...
   <ul> 
    ...
    <li><a href="/publish/observations/hourly-winds.html" target="_self">风</a></li> 
   ...
   <ul> 
    <li><a href="/publish/weather-bulletin/index.htm" target="_self">天气公报</a></li> 
    <li><a href="/publish/weatherperday/index.htm" target="_self">每日天气提示</a></li> 
    <li><a href="/publish/country/warning/downpour.html" target="_self">气象灾害预警</a></li> 
    <li><a href="/publish/precipitation/1-day.html" target="_self">1-7天降水量预报</a></li> 
  ...
  <div> 
   <div class="container"> 
    <div class="titlebg home"> 
     <h1 class="navigation">当前位置：<a href="/publish/forecast/china.html">全国天气预报</a>&nbsp;&gt;&nbsp;<a href="/publish/forecast/AHE.html">河北省</a>&nbsp;&gt;&nbsp;兴隆天气预报</h1> 
     <div class="cityselect"> 
      <span>省份<select id="provinceSel"><option>-</option></select></span> 
      <span>城市<select id="citySel"><option>-</option></select></span> 
     </div> 
    </div> 
    <div class="real"> 
     <div class="left"> 
     ...
     <div class="right"> 
      <p class="livelabel">当前实况<span id="realPublishTime">更新于：发布</span></p> 
      <div class="livetable"> 
       <table> 
        <tbody>
         <tr> 
           ...
           <table> 
            <tbody>
             <tr> 
              ...
              <td class="mdtd">降水<br><br><span id="realRain">&nbsp;</span></td> 
    ...
    <div class="btitle">
     七天天气预报
     <span>发布于：2018-07-16 08:00</span>
    </div> 
    <div id="forecast" class="forecast"> 
     <div class="detail"> 
      <div class="today" style="display:block;"> 
       <table> 
        <tbody>
         <tr> 
          <td> <p class="dname">今天</p><br><p>星期一</p> </td> 
          <td> 07月16日 </td> 
         </tr> 
         <tr> 
          <td><img src="http://image.nmc.cn/static2/site/nmc/themes/basic/weather/white/day/8.png"></td> 
          <td><img src="http://image.nmc.cn/static2/site/nmc/themes/basic/weather/white/night/8.png"></td> 
         </tr> 
         <tr> 
          <td class="wdesc">中雨</td> 
          <td class="wdesc">中雨</td> 
         </tr> 
         <tr> 
          <td class="temp"> 26℃ </td> 
      ...
      <div class="day" style="display:none; margin-left:0;"> 
       <div class="date">
        今天
       </div> 
       <div class="week">
       ...
       <div class="wicon">
        <img src="http://image.nmc.cn/static2/site/nmc/themes/basic/weather/white/day/8.png">
       </div> 
       <div class="wdesc">
        中雨
       </div> 
     ...
     <div class="detail"> 
      <div class="today" style="margin-left:10px;"> 
       <table> 
        <tbody>
         <tr> 
          <td> <p class="dname">明 天</p><br><p>星期二</p> </td> 
          <td> 07月17日 </td> 
         </tr> 
         <tr> 
          <td><img src="http://image.nmc.cn/static2/site/nmc/themes/basic/weather/white/day/9.png"></td> 
          <td><img src="http://image.nmc.cn/static2/site/nmc/themes/basic/weather/white/night/9.png"></td> 
         </tr> 
         <tr> 
          <td class="wdesc">大雨</td> 
          <td class="wdesc">大雨</td> 
         </tr> 
         <tr> 
          <td class="temp"> 25℃ </td> 
      ...
      <div class="day"> 
       ...
       <div class="wicon">
        <img src="http://image.nmc.cn/static2/site/nmc/themes/basic/weather/white/day/9.png">
       </div> 
       <div class="wdesc">
        大雨
       </div> 
     ...
     <div class="detail"> 
      <div class="today" style="margin-left:10px;"> 
       <table> 
        <tbody>
         <tr> 
          <td> <p class="dname">后 天</p><br><p>星期三</p> </td> 
          <td> 07月18日 </td> 
         </tr> 
         <tr> 
          <td><img src="http://image.nmc.cn/static2/site/nmc/themes/basic/weather/white/day/3.png"></td> 
          <td><img src="http://image.nmc.cn/static2/site/nmc/themes/basic/weather/white/night/3.png"></td> 
         </tr> 
         <tr> 
          <td class="wdesc">阵雨</td> 
          <td class="wdesc">阵雨</td> 
         </tr> 
         <tr> 
          <td class="temp"> 27℃ </td> 
     ...
     <div class="detail"> 
      <div class="today" style="margin-left:10px;"> 
       <table> 
        <tbody>
         ...
         <tr> 
          <td><img src="http://image.nmc.cn/static2/site/nmc/themes/basic/weather/white/day/4.png"></td> 
          <td><img src="http://image.nmc.cn/static2/site/nmc/themes/basic/weather/white/night/4.png"></td> 
         </tr> 
         <tr> 
          <td class="wdesc">雷阵雨</td> 
          <td class="wdesc">雷阵雨</td> 
         </tr> 
         <tr> 
          <td class="temp"> 28℃ </td> 
      ...
      <div class="day"> 
       ...
       <div class="wicon">
        <img src="http://image.nmc.cn/static2/site/nmc/themes/basic/weather/white/day/4.png">
       </div> 
       <div class="wdesc">
        雷阵雨
       </div> 
    ...
    <div id="hour3"> 
     ...
     <div id="day1" class="hour3" style="display:none;"> 
      ...
      <div class="row second tqxx"> 
       ...
       <div>
        <img src="http://image.nmc.cn/static2/site/nmc/themes/basic/weather/white/day/10.png">
       </div> 
       <div>
        <img src="http://image.nmc.cn/static2/site/nmc/themes/basic/weather/white/day/8.png">
       </div> 
    ...
    <ul class="tabchar" id="tabchar"> 
     <li class="wdqx"><a class="actived" href="javascript:;">预报曲线</a></li> 
     <li class="jsqx"><a href="javascript:;">24小时实况曲线</a></li> 
    </ul> 
    <div class="tabcontent" id="tabcontent"> 
     <div id="tempchart"></div> 
     <div id="hoursb" style="display: none;"> 
      <div id="hours_title"></div> 
      <div id="hours"></div> 
     </div> 
    </div> 
    <div class="btitle">
  ...
  <script type="text/javascript" src="http://image.nmc.cn/static2/site/nmc/themes/basic/js/Highcharts-4.0.4/js/highcharts.js?v=20180325"></script> 
  <script type="text/javascript" src="http://image.nmc.cn/static2/site/nmc/themes/basic/js/weather_chart.js?v=2017112220180325"></script> 
  <script type="text/javascript" src="http://image.nmc.cn/static2/site/nmc/themes/basic/js/ac.js?v=20180325"></script> 
  <script type="text/javascript">
    $(function () {
    	$('#nav-05').trigger('mouseenter');
    	sunriseset(117.48, 40.42);
    	initReal('54425');
    	initAqi('54425');
    	drawTemperature('54425');
    	changeTab();
    	climate([-1.79,1.36,7.85,16.32,22.93,26.47,27.57,26.7,22.36,15.86,6.94,-0.05],[-15.44,-12.06,-4.87,3.04,9.16,13.94,17.54,15.97,8.99,2.13,-5.32,-12.76],[2.4,4.91,11.93,25.3,47.84,96.65,234.69,171.64,68.26,31.24,10.71,3.64],'兴隆');
    });
  ...
  <input type="hidden" name="页面生成时间" value="2018-07-16 09:03:05">
 </body>
</html>";