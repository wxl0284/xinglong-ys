<?php
//000000003600s:68147:"<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html>
 <head> 
 ...
 <body> 
  ...
  <div id="navbar_sub" class="navbar_sub shadow"> 
   ...
   <ul> 
    <li><a href="/publish/weather-bulletin/index.htm" target="_self">天气公报</a></li> 
    <li><a href="/publish/weatherperday/index.htm" target="_self">每日天气提示</a></li> 
    <li><a href="/publish/country/warning/offshorewind.htm" target="_self">气象灾害预警</a></li> 
    <li><a href="/publish/precipitation/1-day.html" target="_self">1-7天降水量预报</a></li> 
  ...
  <div> 
   <div class="container"> 
    ...
    <div class="btitle">
     七天天气预报
     <span>发布于：2017-10-20 08:00</span>
    </div> 
  ...
  <input type="hidden" name="页面生成时间" value="2017-10-20 09:02:26">
 </body>
</html>";
?>